...
class Eci_Ecishipping_Adminhtml_Ecishipping_ItemController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout();
        $this->_setActiveMenu('eciintel/ecishipping/ecishippingitem');
        $this->_title($this->__('EC-Intelligent'))->_title($this->__('Shipping'))->_title($this->__('Item'));
