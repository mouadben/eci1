...
class Eci_Ecishipping_Adminhtml_Ecishipping_MethodController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout();
        $this->_setActiveMenu('eciintel/ecishipping/ecishippingmethod');
        $this->_title($this->__('EC-Intelligent'))->_title($this->__('Shipping'))->_title($this->__('Methods'));
    ...
    protected function _getAssignedItemIds()
    {
        ...
        $assignedItemIds = $assignedItemIds ? $assignedItemIds : array();
