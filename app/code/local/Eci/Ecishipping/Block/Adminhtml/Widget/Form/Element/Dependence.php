...
class Eci_Ecishipping_Block_Adminhtml_Widget_Form_Element_Dependence extends Mage_Adminhtml_Block_Widget_Form_Element_Dependence
{
    /**
...
$js = <<<JS
EcishippingFormElementDependenceController = Class.create();
EcishippingFormElementDependenceController.prototype = {
    /**
...
JS;
        return '<script type="text/javascript"> 
            ...
            new EcishippingFormElementDependenceController('
